...
urlpatterns = [
    ...
    path('<int:course_id>/live/', views.live_class_list, name='live_class_list'),
    path('<int:course_id>/live/new/', views.create_live_class, name='create_live_class'),
    ...
    path('video/<int:video_id>/ai-quiz/', views.ai_generate_quiz, name='ai_generate_quiz'),
