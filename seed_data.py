...
video_urls = {
    c1: 'https://www.youtube.com/watch?v=rfscVS0vtbw',   # Python full course
    c2: 'https://www.youtube.com/watch?v=F5mRW0jo-U4',   # Django crash course
    c3: 'https://www.youtube.com/watch?v=HXV3zeQKqGY',   # SQL tutorial
    c4: 'https://www.youtube.com/watch?v=i_LwzRVP7bg',   # ML intro
    c5: 'https://www.youtube.com/watch?v=RGOj5yH7evk',   # Git tutorial
    c6: 'https://www.youtube.com/watch?v=hdI2bqOjy3c',   # JS crash course
}
