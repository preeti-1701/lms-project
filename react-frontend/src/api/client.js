...
function getToken() {
  return localStorage.getItem('learnnova_token')
}

export function setToken(token) {
  localStorage.setItem('learnnova_token', token)
}

export function clearAuth() {
  localStorage.removeItem('learnnova_token')
  localStorage.removeItem('learnnova_user')
}

export function getStoredUser() {
  const u = localStorage.getItem('learnnova_user')
  return u ? JSON.parse(u) : null
}

export function setStoredUser(user) {
  localStorage.setItem('learnnova_user', JSON.stringify(user))
}
