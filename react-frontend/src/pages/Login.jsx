    ...
    <div className="login-page">
      <div className="login-left">
        <div>
          ...
          <h2>
            Learn topics <em>you</em> care about.
          </h2>
        </div>
        <p>
          A simple learning space to join courses,
      ...
      <div className="login-right">
        ...
        <div className="demo-accounts">
          <strong>Demo access</strong> (password for all: <code>demo1234</code>)<br />
          Learner: <code>student@demo.com</code><br />
