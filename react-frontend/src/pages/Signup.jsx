    ...
    <div className="login-page">
      <div className="login-left">
        <div>
          ...
          <h2>
            {step === 'form' ? (
              <>Start your <em>learning</em> journey today.</>
            ) : (
              <>Almost <em>there.</em></>
            )}
          </h2>
        ...
        <p>
          {step === 'form'
            ? "Create a free student account. We'll send a 6-digit code to your email to verify it's really you."
            : `We sent a 6-digit code to ${formData.email}. Enter it below to verify your account.`}
        </p>
      </div>
      ...
      <div className="login-right">
        ...
        {step === 'otp' && (
          <>
            ...
            {error && <div className="error-msg">{error}</div>}
            {success && (
              <div className="error-msg" style={{ background: '#e4f1dc', color: 'var(--success)', borderLeftColor: 'var(--success)' }}>
                {success}
              </div>
            )}
            ...
            <div style={{ marginTop: '1rem', fontSize: '0.85rem', color: 'var(--ink-softer)', textAlign: 'center' }}>
              <a onClick={() => setStep('form')} style={{ cursor: 'pointer' }}>← Use a different email</a>
            </div>
          </>
        )}
      </div>
