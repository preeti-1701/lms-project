...
target = r'c:/Users/Manjunath C H/OneDrive/Pictures/lms_mca/frontend/src/pages/CoursePlayer.jsx'
...
export default function CoursePlayer() {
  ...
  const fetchProgress = async () => {
    try {
      ...
      setProgress(res.data.results || res.data || [])
    } catch { /* ignore */ }
  }
...
print('CoursePlayer.jsx written, chars:', len(content))
