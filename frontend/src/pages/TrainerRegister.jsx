...
const TrainerRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Trainer registration successful. You can now login.');
    ...
    <div className="flex items-center justify-center min-h-[85vh] bg-slate-50 px-4">
      <div className="w-full max-w-md bg-white p-10 rounded-[2.5rem] shadow-soft border border-slate-100 animate-fade-in">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Trainer Enrollment</h1>
          <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-2">Join Our Education Team</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Professional Email</label>
            <input
              type="email"
              required
              className="input-simple"
          ...
          <div className="space-y-2">
            <label className="block text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Create Password</label>
            <input
              type="password"
              required
              className="input-simple"
          ...
          >
            {isLoading ? 'Processing...' : 'Register as Trainer'}
          </button>
        </form>
        ...
        <div className="mt-10 pt-8 border-t border-slate-50 text-center">
          ...
          >
            Already have a trainer account? <span className="text-amber-600 font-black">Login here</span>
          </button>
        </div>
      </div>
    </div>
