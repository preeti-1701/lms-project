      ...
      <header className="sticky top-0 z-40 border-b border-border/40 bg-background/60 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <nav className="hidden items-center gap-8 text-sm text-muted-foreground md:flex">
            ...
            <a href="#security" className="transition-smooth hover:text-foreground">Security</a>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-balance text-5xl font-bold tracking-tight md:text-7xl">
              <span className="text-gradient">Learning, reimagined</span>
              <br />
              <span className="text-foreground">for serious teams.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Button size="lg" variant="outline" className="h-12 border-border/70 bg-muted/30 px-7 backdrop-blur">
